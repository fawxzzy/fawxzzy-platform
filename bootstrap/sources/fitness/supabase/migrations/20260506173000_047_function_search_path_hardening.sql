...
begin
  ...
  set status = 'processing',
      attempt_count = public.session_follow_up_jobs.attempt_count + 1,
      last_error = null,
      completed_at = null,
  ...
  returning
    public.session_follow_up_jobs.id,
    public.session_follow_up_jobs.job_kind,
    public.session_follow_up_jobs.status,
    public.session_follow_up_jobs.attempt_count;
end;
$$;
