...
export function verifyFitnessAppDataAdapter({ adapter, gate }) {
  ...
  const actualRelationCore = (Array.isArray(adapter?.relations) ? adapter.relations : []).map((relation) => [relation.source_relation, relation.target_relation, relation.classification, relation.transport_mode]);
