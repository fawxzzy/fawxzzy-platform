...
const exactActivationGates = Object.freeze([
  ...
  Object.freeze({ gate: 'custom_smtp_configuration_readback_and_synthetic_delivery_proof', status: 'REQUIRED' }),
...
const exactNegativeProbes = Object.freeze([
  ...
  'UNAUTHENTICATED_EXCHANGE_ISSUANCE_REJECTED',
  'CALLER_SELECTED_EXCHANGE_SUBJECT_REJECTED',
  'PENDING_EXCHANGE_AFTER_REVOKED_SESSION_REJECTED',
  'SESSION_MATERIAL_LOG_SINK_NON_ECHOING',
  'AUTHORIZATION_CODE_LOG_SINK_NON_ECHOING',
...
const exactPositiveProbes = Object.freeze([
  ...
  'PASSWORD_64_CHARACTER_EXACT_VALUE_ACCEPTED',
  'INHERITED_SESSION_SECURITY_READBACK_AND_RUNTIME_PROOF',
